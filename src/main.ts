...
const lavoratore: Dipendente = {
  ...
  annoNascita: 1997,
  sesso: "m",
  anniDiServizio: [2015, 2016, 2017, 2018, 2019, 2020],
  emailAziendale: "marco.rossi@emailAziendale.it",
...
const developer: Developer = {
  ...
  emailAziendale: "federico.rossi@mailAziendale.it",
  contratto: "freelance",
  livelloEsperienza: "Senior",
  linguaggi: ["Javascript", "Typescript", "Java", "Python"],
  certificazioni: [],
};
...
const projectManager: ProjectManager = {
  ...
  annoNascita: 1990,
  sesso: "m",
  anniDiServizio: [2018, 2019, 2020, 2021, 2022, 2023],
  emailAziendale: "michele.rossi@mailAziendale.it",
  contratto: "Indeterminato",
  teamSize: 6,
  budgetGestito: 15000,
...
console.log(lavoratore, developer, projectManager);
